...
import com.experian.dvs.client.server.address.format.RestApiEnrichmentUKLocationEssential;

import java.util.Objects;

public class UKLocationEssential {
    ...
    public UKLocationEssential(RestApiEnrichmentUKLocationEssential api) {
