...
import com.experian.dvs.client.address.format.FormatAddress;
...
public class SuggestionsFormatSuggestion {
    ...
    public SuggestionsFormatSuggestion(final RestApiSuggestionsFormatSuggestion suggestion) {
        if (suggestion != null) {
            this.globalAddressKey = Objects.toString(suggestion.getGlobalAddressKey(), "");
            this.address = suggestion.getAddress() != null ? new FormatAddress(suggestion.getAddress()) : null;
