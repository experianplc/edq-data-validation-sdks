...
/**
 * Client class for managing address layouts.
...
public class AddressLayoutClient implements Closeable {
    ...
    /**
     * Initializes a new instance of the {@link AddressLayoutClient} class with the specified configuration.
     *
     ...
     *
     * @return The {@link AddressLayoutConfiguration} object.
     */
