...
public abstract class AddressElementLibrary {

    private AddressElementLibrary() {
    ...
    public static AddressElement getAddressElementFromElementName(final Dataset dataset, final String elementName) {
        final Map<String, AddressElement> elementNameToAddressElementMap = ELEMENT_NAME_TO_ADDRESS_ELEMENT_MAP.computeIfAbsent(dataset, AddressElementLibrary::getElementNameToAddressElementMap);
