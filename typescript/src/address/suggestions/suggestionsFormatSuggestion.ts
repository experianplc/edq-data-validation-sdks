...
export type suggestionsFormatSuggestion = {
...
export function restApiResponseToSuggestion(response: RestApiSuggestionsFormatSuggestion): suggestionsFormatSuggestion {

    const result: suggestionsFormatSuggestion = {
